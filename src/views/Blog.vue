        ...
        <div class="container">
            ...
            <section class="articles">
                <div class="column is-8 is-offset-2">
                        ...
                        <div class="card-content">
                            <div class="columns">
                                <div class="column is-9">
                                    <p class="title author-name">
                                        Matt-Klaus Mushi
                                    </p>
                                    <p class="subtitle author-caption">
                                        A writer and coach who has the ultimate goal to see others get better and be
                                        very productive in what they do. Join my mailing list here.
                                    </p>
                                    <span class="follows">
                                        <span class="following">201 Following</span> &nbsp;&nbsp;&nbsp; <span class="followers">105 Followers</span>
                                    </span>
                                </div>
                                <div class="column is-3" style="padding: 0;">
                                    <div class="author">
                                        <img class="img" src="/images/phil.jpeg" alt="Phil">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="tabs">
                        <ul>
                            <li class="is-active"><a>Featuring</a></li>
                            <li><a>Following</a></li>
                            <li><a>Followers</a></li>
                            <li><a>All</a></li>
                        </ul>
                    </div>
                    <div class="card article" v-for="i in 5" :key="i">
                        <div class="card-content article-head">
                            <div class="media">
                                <div class="media-center">
                                    <img src="http://www.radfaces.com/images/avatars/daria-morgendorffer.jpg"
                                         class="author-image" alt="Placeholder image">
                                </div>
                                <div class="media-content has-text-centered">
                                    <p class="article-title">Why going ‘off-grid’ is important for the creative process
                                        🔱</p>

                                    <p class="subtitle is-6 article-subtitle">
                                    <div class="control">
                                        <b-taglist attached>
                                            <b-tag type="is-dark">@daria</b-tag>
                                            <b-tag type="is-info"> on February 17, 2018</b-tag>
                                        </b-taglist>
                                    </div>
                                    </p>
                                </div>
                        ...
                        <div class="card-content article-claps">
							<span class="bb">
								<div class="ex">
									<div class="dr">
										<svg width="25" height="25" viewBox="0 0 25 25"
                                             xmlns="http://www.w3.org/2000/svg" class="ey j">
											<g fill-rule="evenodd">
									...
									<div class="ds u ci v">11 responses</div>
									<div class="ds u ci v">
										<div class="ez j">
											<svg width="25" height="25" viewBox="0 0 25 25"
